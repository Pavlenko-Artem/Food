...
function forms(formSelector, modalTimerId) {
	...
	function showThanksModal(message, modalSelector) {
		...
		(0,_modals__WEBPACK_IMPORTED_MODULE_0__.openModal)(modalSelector, modalTimerId);
		...
		setTimeout(() => {
			...
			(0,_modals__WEBPACK_IMPORTED_MODULE_0__.closeModal)(modalSelector);
		}, 4000)
	}
}
...
window.addEventListener('DOMContentLoaded', () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-04-16');
